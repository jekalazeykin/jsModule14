...
TimeForPrint.prototype.stop = function () {
  ...
  TimeForPrint.interval = TimeForPrint.stopTime - TimeForPrint.startTime;
    let print = new TimeForPrint (TimeForPrint.startTime, TimeForPrint.stopTime, TimeForPrint.interval);
    console.log(print);
